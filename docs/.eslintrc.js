module.exports = {
  ...
  plugins: ["@typescript-eslint/eslint-plugin", "@docusaurus"],
  extends: ["eslint:recommended", "plugin:@typescript-eslint/recommended", "plugin:prettier/recommended", "plugin:@docusaurus/all"],
  root: true,
  env: {
    node: true,
    jest: true,
